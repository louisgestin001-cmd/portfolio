...
This project was developed with substantial assistance from OpenAI's ChatGPT.

AI assistance contributed to:

- translating candidate equations into executable PyTorch code;
- designing diagnostic and benchmark tasks;
- running and interpreting preliminary experiments;
...
5. **unestablished novelty**, which requires a systematic literature review.

The project does not claim unaided authorship, established state-of-the-art performance, or peer-reviewed novelty.
